...
1. Run docker image (and save the results in my computer):
	...
	docker run --network=host -it --rm -v /home/bmrc/Public/phil_ubuntu/sc/airr/immcantation/outs/outs_wt:/home/phil_docker:z immcantation/suite:4.1.0 bash
...
png("graph2.png",width=8,height=6,unit="in",res=300)
plot(db$trees[[5]],show.node.label=TRUE)
